...
if(document.addEventListener ){ 
   ...
   aLoader = [
    ...
    { load: "edge_includes/edge.2.0.1.min.js"},
          { load: "invitation7_edge.js"},
          { load: "invitation7_edgeActions.js"}];
...
preContent={
   dom: [
   {
      ...
      type:'image',
      tag:'img',
      rect:['43.4%','368px','88px','88px','auto','auto'],
      fill:["rgba(0,0,0,0)",'images/preloader5.gif','0px','0px']
   },
   {
      id:'Text',
      type:'text',
      rect:['43.3%','496px','13.4%','2.5%','auto','auto'],
      text:"载入中<br>",
      align:"center",
      font:['Arial, Helvetica, sans-serif',24,"rgba(120,120,120,1.00)","normal","none",""]
   },
   {
      id:'TextCopy',
      type:'text',
      rect:['26.4%','536px','46.6%','2.5%','auto','auto'],
      text:"Powered by 舟山数据客",
      align:"center",
      font:['Arial, Helvetica, sans-serif',24,"rgba(120,120,120,1.00)","normal","none",""]
   }]};//simpleContent
...
dlContent={
   dom: [
   {
      id:'Text',
      type:'text',
      rect:['43.3%','7.7%','auto','auto','auto','auto'],
      text:"Loading",
